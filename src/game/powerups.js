...
export function rollPowerupDrop(enemy, state) {
    ...
    if (enemy.r > 15)
        dropChance = 0.3; // 30% for bosses
    else if (enemy.type === 'rye')
        dropChance = 0.15; // 15% for tough enemies
    else if (enemy.type === 'baguette')
        dropChance = 0.08; // 8% for medium enemies
